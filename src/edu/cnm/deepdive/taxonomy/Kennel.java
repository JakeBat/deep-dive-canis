 ...
 * classes to demonstrate inheritance and polymorphism. This models binomial 
 * taxonomy of genus and species, as well as sub-species.
 * 
 * @author jake_
 *
 */
public class Kennel {
   ...
   * {@link CanisLupusFamiliaris} classes.
  ...
  /**
   * Invokes a number of methods on the {@link CanisLupus} instance passed to it as a parameter. If
   * the instance type is actually {@link CanisLupusFamiliaris}, then the {@link CanisLupusFamiliaris#isGoodBoy()} method is also invoked.
   * 
   * @param wolf    instanced exercised.
   */
